...
export default function ProviderFailedPage() {
  return (
    <div className="min-h-screen bg-[#FBFBFB] flex items-center justify-center p-6 font-jakarta">
      <div className="max-w-lg w-full">
        ...
        >
          ...
          <h1 className="text-4xl font-black text-[#101828] mb-4 tracking-tight">Connection Failed</h1>
          <p className="text-gray-500 font-medium mb-10 leading-relaxed">
            We couldn't connect your email account. This usually happens if the permissions were denied or the session expired.
          </p>
