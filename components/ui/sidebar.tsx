        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              {(() => {
                const dashboardActive = segments.includes('dashboard') || segments.includes('team-dashboard')
                return (
                  <SidebarLinkGroup open={dashboardActive}>
                    {(handleClick, open) => (
                      <>
                        <a
                          href="#0"
                          className={`block text-gray-800 dark:text-gray-100 truncate transition ${dashboardActive ? '' : 'hover:text-gray-900 dark:hover:text-white'}`}
                          onClick={(e) => {
                            e.preventDefault();
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg className={`shrink-0 fill-current ${dashboardActive ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                          <ul className={`pl-8 mt-1 ${!open && 'hidden'}`}>
                            ...
                            <li className="mb-1 last:mb-0">
                              <SidebarLink href="/team-dashboard">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Team Performance
                                </span>
                              </SidebarLink>
